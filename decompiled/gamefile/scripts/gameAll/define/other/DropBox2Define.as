package gameAll.define.other
{
   ...
   public class DropBox2Define
   {
      ...
      public function DropBox2Define()
      {
         super();
         this.type_arr.push("GCoin,\t\t100000,\t\t\t1");
         ...
         this.type_arr.push("props,\t\tdisassemble_3,\t1");
         this.pro_arr = [0.39,0.1,0.1,0.1,0.1,0.05,0.05,0.05,0.005,0.005,0.05];
      }
