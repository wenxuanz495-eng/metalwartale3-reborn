package gameAll.define
{
   ...
   public class FlipCardDefine
   {
      ...
      public var coin_arr:Array = [10000];
      
      public var superalloyName_arr:Array = ["superalloy_X"];
      
      public var superalloyNum_arr:Array = [10];
      
      public var propName_arr:Array = ["rebirth_crystal"];
      
      public var propNum_arr:Array = [1];
      
      public var materialName_arr:Array = ["buncher","boom","thorn"];
      
      public var materialNum_arr:Array = [5,5,5];
      ...
      public function getGoodsDefineStr_byType(type0:String, level0:int) : String
      {
         ...
         if(type0 == "exp")
         {
            ...
            str0 = "exp," + int(this.exp_arr[level0] * baifen0) + ",1";
         }
         else if(type0 == "coin")
         {
