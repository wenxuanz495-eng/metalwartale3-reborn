package gameAll.define
{
   ...
   public class ArenaFlipCardDefine
   {
      ...
      public var coin_arr:Array = [15000];
      
      public var superalloyName_arr:Array = ["superalloy_X"];
      
      public var superalloyNum_arr:Array = [15];
      ...
      public var propNum_arr2:Array = [1];
      ...
      public var pro_arr:Array = [0.36,0.3,0.3,0.02,0.02];
      
      public var number10w:String = TextWay.toCode("15000");
      
      public function ArenaFlipCardDefine()
      {
         super();
      }
