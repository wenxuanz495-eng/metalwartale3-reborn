package gameAll.define
{
   ...
   public class UnionFlipCardDefine
   {
      ...
      public var coin_arr:Array = [50000];
      
      public var superalloyName_arr:Array = ["superalloy_X"];
      
      public var superalloyNum_arr:Array = [50];
      
      public var propName_arr:Array = ["justice2_badge"];
      
      public var propNum_arr:Array = [5];
      
      public var propName_arr2:Array = ["superalloyStone"];
      
      public var propNum_arr2:Array = [2];
      ...
      public var type_arr:Array = ["coin","prop","superalloy","prop2","arms"];
      
      public var pro_arr:Array = [0.32,0.3,0.3,0.04,0.04];
      
      public var number10w:String = TextWay.toCode("50000");
      
      public function UnionFlipCardDefine()
      {
         super();
      }
      ...
      public function getGoodsDefineStr_byType(type0:String, level0:int) : String
      {
         ...
         else if(type0 == "material")
         {
            ...
            str0 = "materials," + name0 + "_" + this.getMaterialLevel(level0) + "," + this.materialNum_arr[len];
         }
         else if(type0 == "prop")
         {
         ...
         {
            len = int(this.propName_arr2.length * Math.random());
            name0 = this.propName_arr2[len];
            str0 = "props," + name0 + "," + this.propNum_arr2[len];
         }
         else if(type0 == "arms")
         {
