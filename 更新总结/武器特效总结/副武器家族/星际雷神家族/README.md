...
| 星际雷神家族MK2重塑与MK1对齐执行总结-V45~V52-20260919.md | V45~V52 八连：部件2/双弹参考对位、蓄力五帧链装回、弹道联动、独立 3 秒装填、同帧衔接（附 sub1130 哈希链） |
| 贴图资产标记审计与漏洞清单-20260919.md | 资产↔SWF 标签链路总表（导出名/深度/字符/位图/PNG 逐像素验证）、MK1 无弃用文件、MK2 五张弃用图（星际雷神.png+星际雷神特效1~4）、孤儿字符与命名陷阱清单 |
| 贴图索引.md | **活页 SSOT**：部位标签→深度/字符/位图/PNG/当前态锚点值双向速查，弃用资产隔离区；每轮修订必须同步更新 |
