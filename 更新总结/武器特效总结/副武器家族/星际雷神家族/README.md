...
- **数值现状（当前版，两级统一）**：`attackGap=7.6`、`attackDelay=0.43`（V31 重型节奏）、`bulletNum=2`（双发）、`bulletSpeed=12`、`bulletMaxV=30`、`bulletLife=2.5`、`bulletWidth=7`、`hurt=80`、`energyUse=10`、`recoilValue=2`；`bulletTranslation` lv1=11.5 / lv2=11.05（V33 定版）
