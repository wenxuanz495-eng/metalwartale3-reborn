...
> 当前状态：✅* **皮肤与发射特效整体替换已构建入库待实测（2026-09-17）**——先读 `星际雷神家族皮肤与发射特效替换执行总结-20260917.md`：34 项新 ID 2900~2933，双本体（lv1 炮口尖对齐 tx-370/ty-90、lv2 同尺寸零位移）＋lv1 特效1~4／lv2 新特效1~5（f8 延长 1 帧）＋双联装尾焰开火1~3 上下筒各一份（f4~f6）＋部件2 双弧（f4 放/f6 撤＝装填）＋共用新弹图；**零形态/零数值/零配置、无新导出名**；sub1130=920B4611、game.swf=F8BCD766 未变；构建 0＋双自检 0。**本家族为当前版独有，旧版均无此武器**，无旧版回迁面。
...
| 文件/目录 | 内容 |
|---|---|
| 星际雷神家族皮肤与发射特效替换执行总结-20260917.md | **先读**：皮肤＋发射特效整体替换（34 项新 ID／双本体／双尾焰／双弧／lv2 延长帧；四段式含待实机 7 项） |
| 预览-sprite121-逐帧.png / 预览-sprite115-逐帧.png | 改后时间轴逐帧重放预览（f1/f4~f9） |
| zzzd_skin_import.py | 导入脚本（断言齐全，可精确复跑） |
