...
> 当前状态：✅ **20260914 三连修已完成并部署**：①红弹移除＋圈链回枪轴线（354DCBA6）；②圈链剑柄对心＋两次归位修正：小白圈脉冲贴剑柄（用户取色两轮微调定稿，矩阵 (98,552)）＋大圈链 8 处全在枪头 2.5 原位（**4AB12D99**，仅 391；399 未动待用户实机决策）。待实机验收：剑柄聚能观感、峰值光球幅度、镜像关卡。
