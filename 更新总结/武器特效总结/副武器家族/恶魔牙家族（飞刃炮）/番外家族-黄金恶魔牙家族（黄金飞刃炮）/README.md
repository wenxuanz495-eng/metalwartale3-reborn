...
> 当前状态：✅ **20260914 三连修已完成并部署**：①红弹移除＋圈链回枪轴线（354DCBA6）；②圈链剑柄对心＋同日修正：蓄力小圈同心剑柄 (24,38.5)px、枪口火焰组在枪头（**ED117A18**，仅 391；399 未动待用户实机决策）。待实机验收：剑柄聚能观感、峰值光球幅度、镜像关卡。
...
| 文件/目录 | 内容 |
|---|---|
| 黄金恶魔牙圈链剑柄对心-20260914.md | **最新**：蓄力圈对心剑柄＋枪口火焰组留枪头（含同日修正记录，部署版 ED117A18） |
